...
public class TelaLocais extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botaoPython, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 470, 210, 50));
        ...
        getContentPane().add(botaoJava, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 470, 200, 50));

        botaoC2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/C#.png"))); // NOI18N
        botaoC2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        botaoC2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botaoC2ActionPerformed(evt);
            }
        });
        getContentPane().add(botaoC2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 200, 50));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Local laboratorio.jpeg"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Local C#.jpeg"))); // NOI18N
    ...
    private void botaoPythonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPythonActionPerformed
        // TODO add your handling code here:
        TelaCombate python = new TelaCombate();
