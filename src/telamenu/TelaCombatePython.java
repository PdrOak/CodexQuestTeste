...
public class TelaCombatePython extends javax.swing.JFrame {

    public TelaCombatePython(String dificuldade, int contador) {
        initComponents();
    ...
    public void proximaFase(String dificuldade) {
        if (dificuldade.equals("facil")) {
            TelaCombatePython tela = new TelaCombatePython("medio", contador);
            tela.setVisible(true);
            dispose();

        } else if (dificuldade.equals("medio")) {

            TelaCombatePython tela = new TelaCombatePython("dificil", contador);
            tela.setVisible(true);
            dispose();
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblcoracaom1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, -1, -1));

        lblcoracaom2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons8-coração-de-pixel-30.png"))); // NOI18N
        getContentPane().add(lblcoracaom2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, -1, -1));

        lblcoracaom3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons8-coração-de-pixel-30.png"))); // NOI18N
        getContentPane().add(lblcoracaom3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, -1, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Mestre Python.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/layout jogador.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 240, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/linguagempython.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 30, -1, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/bi_person-circle.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/localPython(fundo).jpeg"))); // NOI18N
    ...
    private void btnAlt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt1ActionPerformed
        ...
        if (dificuldade.equals("facil")) {
            ...
            } else if (validarResposta(3) || validarResposta(4)) {
        ...
        if (dificuldade.equals("medio")) {
            ...
            } else if (validarRespostaMedio(3) || validarRespostaMedio(4)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void btnAlt2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt2ActionPerformed
        ...
        if (dificuldade.equals("medio")) {
            if (validarRespostaMedio(1) || validarRespostaMedio(3) || validarRespostaMedio(4)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void btnAlt3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt3ActionPerformed
        ...
        if (dificuldade.equals("facil")) {
            if (validarResposta(3)) {
                ...
                JOptionPane.showMessageDialog(null, "Você acertou");
                proximaFase(dificuldade);
            } else if (validarResposta(1) || validarResposta(4)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
        ...
        if (dificuldade.equals("medio")) {
            ...
            } else if (validarRespostaMedio(1) || validarRespostaMedio(4)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void btnAlt4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt4ActionPerformed
        ...
        if (dificuldade.equals("facil")) {
            ...
            } else if (validarResposta(1) || validarResposta(3)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
        ...
        if (dificuldade.equals("medio")) {
            ...
            } else if (validarRespostaMedio(1) || validarRespostaMedio(3)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String perguntaFacil = String.format("/perguntas/perguntaspython/faceis/pergunta%d.png", pergunta);
        lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaFacil)));

        String alternativaFacil = String.format("/respostas/respostaspython/facil/questao%d", pergunta);
        ...
        if (dificuldade.equals("medio")) {
            ...
            String perguntaMedio = String.format("/perguntas/perguntaspython/medias/pergunta%d.png", perguntaMed);
            lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaMedio)));

            String alternativaMedio = String.format("/respostas/respostaspython/medio/questao%d", perguntaMed);
            ...
            String perguntaDificil = String.format("/perguntas/perguntaspython/dificeis/pergunta%d.png", perguntaDif);
            lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaDificil)));

            String alternativaDificil = String.format("/respostas/respostaspython/dificil/questao%d", perguntaDif);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCombatePython.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCombatePython().setVisible(true);
            }
        });
    }
