...
public class TelaCombateCSharp extends javax.swing.JFrame {

    public TelaCombateCSharp(String dificuldade, int contador) {
        initComponents();
    ...
    public void proximaFase(String dificuldade) {
        if (dificuldade.equals("facil")) {
            TelaCombateCSharp tela = new TelaCombateCSharp("medio", contador);
            tela.setVisible(true);
            dispose();

        } else if (dificuldade.equals("medio")) {

            TelaCombateCSharp tela = new TelaCombateCSharp("dificil", contador);
            tela.setVisible(true);
            dispose();

        } else if (dificuldade.equals("dificil")) {
            lblcoracaom3.setEnabled(false);
            JOptionPane.showMessageDialog(null, "Você ganhou do Mestre C Sharp, recebeu o troféu que garante sua conquista,"
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/linguagemc#.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 20, 130, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Mestre CSharp.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/localCSharp(fundo).jpeg"))); // NOI18N
    ...
    private void btnAlt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt1ActionPerformed
        ...
        if (dificuldade.equals("medio")) {
            ...
            if (validarRespostaMedio(2) || validarRespostaMedio(3)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void btnAlt2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlt2ActionPerformed
        ...
        if (dificuldade.equals("medio")) {
            ...
            if (validarRespostaMedio(1) || validarRespostaMedio(3)) {
                if (lblcoracaoj1.isEnabled() == true) {
                    lblcoracaoj1.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Você errou :(");
                    contadorErros(contador += 1);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String perguntaFacil = String.format("/perguntas/perguntascsharp/faceis/pergunta%d.png", pergunta);
        lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaFacil)));

        String alternativaFacil = String.format("/respostas/respostascsharp/facil/questao%d", pergunta);
        ...
        if (dificuldade.equals("medio")) {
            ...
            String perguntaMedio = String.format("/perguntas/perguntascsharp/medias/pergunta%d.png", perguntaMed);
            lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaMedio)));

            String alternativaMedio = String.format("/respostas/respostascsharp/medio/questao%d", perguntaMed);
            ...
            String perguntaDificil = String.format("/perguntas/perguntascsharp/dificeis/pergunta%d.png", perguntaDif);
            lblPergunta.setIcon(new ImageIcon(getClass().getResource(perguntaDificil)));

            String alternativaDificil = String.format("/respostas/respostascsharp/dificil/questao%d", perguntaDif);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCombateCSharp.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCombateCSharp().setVisible(true);
            }
        });
    }
